          ...
          return GestureDetector(
            onTap: () async {
              if (await canLaunch(
                ...
                await launch('https://www.instagram.com/${ambassador.username}',
            ...
            child: Stack(children: [
              Neumorphic(
                ...
                child: Center(
                  child: Image.network(ambassador.analytics.postsUrl[ind],
                      fit: BoxFit.contain),
                ),
              ),
              Positioned(
                ...
                child: Neumorphic(
                    ...
                    child: Row(
                      children: [
                        Text('${ambassador.analytics.likesGraph[ind]}',
                            style: TextStyle(
              ...
              Positioned(
                ...
                child: Neumorphic(
                    ...
                    child: Row(
                      children: [
                        Text('${ambassador.analytics.commentsGraph[ind]}',
                            style: TextStyle(
                                color: NeumorphicTheme.isUsingDark(ctx)
                                    ? Colors.yellow[100]
                                    : Colors.black,
